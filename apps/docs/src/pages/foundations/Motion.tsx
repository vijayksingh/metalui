    ...
    <>
      ...
      <Section title="Springs" lede="Hover the card, press the cap, or use Play all in the dial panel. Tune stiffness and damping and the readouts update.">
        <div className="grid gap-16 md:grid-cols-2 [&>*]:min-w-0">
          <Bench caption="obj · objects, hover lift, card slides">
          ...
          <Bench caption="flap · flap tilt, drawers">
            <div className="flex flex-col items-center gap-20">
          ...
          <Bench caption="ui · thumbs, toggles, ticks">
            <div className="flex flex-col items-center gap-20">
          ...
          <Bench caption="press · lands in 50ms, releases on a spring">
            <div className="flex flex-col items-center gap-20">
              <motion.button
                type="button"
      ...
      <Section title="Rules">
        <Rules
          rules={[
            ...
            { id: 'M4', title: 'Reduced motion keeps feedback', body: 'Transitions become instant and loops stop; the 1-point press travel stays.' },
          ]}
        />
      </Section>
    </>
