...
export const ICON_CATALOG = {
  ...
  /* ─────────────────────────────────────────────────────────
   * DUPLICATE · Actions · one act, 1183ms
   *
   * Press → Peel off → Land
   *          The copy slides back onto the original, presses to take its impression, and is peeled off into place.
   *  copy       0 → 200 → 270 → 330 → 470 → 826 → 1183ms
   *  glint      0 → 690 → 770 → 1060 → 1183ms
   * Plays once through on hover, focus or click; finishes if the pointer leaves.
   * REDUCED MOTION   static glyph
   * ───────────────────────────────────────────────────────── */
  "duplicate": {
    label: "Duplicate",
    category: "Actions",
    hover: "The copy slides back onto the original, presses to take its impression, and is peeled off into place.",
    press: "plays the same act",
    pressMs: 1183,
   ...
   *          The well turns and draws the dot round and down into its centre; it goes under with a gulp and a new dot rises on the rim.
   *  well       0 → 160 → 700 → 780 → 1080 → 1200 → 1245ms
   *  orb        0 → 120 → 160 → 299 → 370 → 426 → 475 → 519 → 560 → 598 → 634 → 668 → 700 → 740 → 800 → 1245ms
   *  rad        0 → 120 → 160 → 299 → 370 → 426 → 475 → 519 → 560 → 598 → 634 → 668 → 700 → 740 → 800 → 1245ms
   *  dot        0 → 160 → 290 → 560 → 700 → 720 → 860 → 940 → 1245ms
   *  gulp       0 → 690 → 740 → 960 → 1245ms
   * Plays once through on hover, focus or click; finishes if the pointer leaves.
   * REDUCED MOTION   static glyph
   * ───────────────────────────────────────────────────────── */
  "send-away": {
    ...
    sw16: 1.9,
    motion: {"duration":1245,"caption":"The well turns and draws the dot round and down into its centre; it goes under with a gulp and a new dot rises on the rim.","stages":["Wind up","Draw in","Rise again"],"tracks":[{"part":"well","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.12851,"transform":"translate(0px,0px) rotate(-6deg) scale(1,1)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.56225,"transform":"translate(0px,0px) rotate(24deg) scale(1,1)","easing":"cubic-bezier(.22,1,.36,1)"},{"offset":0.62651,"transform":"translate(0px,0px) rotate(26deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.86747,"transform":"translate(0px,0px) rotate(-1.5deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.96386,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)"}]},{"part":"orb","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.09639,"transform":"translate(0px,0px) rotate(12deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.12851,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.24016,"transform":"translate(0px,0px) rotate(-30deg) scale(1,1)","easing":"linear"},{"offset":0.29719,"transform":"translate(0px,0px) rotate(-60deg) scale(1,1)","easing":"linear"},{"offset":0.34217,"transform":"translate(0px,0px) rotate(-90deg) scale(1,1)","easing":"linear"},{"offset":0.38153,"transform":"translate(0px,0px) rotate(-120deg) scale(1,1)","easing":"linear"},{"offset":0.41687,"transform":"translate(0px,0px) rotate(-150deg) scale(1,1)","easing":"linear"},{"offset":0.4498,"transform":"translate(0px,0px) rotate(-180deg) scale(1,1)","easing":"linear"},{"offset":0.48032,"transform":"translate(0px,0px) rotate(-210deg) scale(1,1)","easing":"linear"},{"offset":0.50924,"transform":"translate(0px,0px) rotate(-240deg) scale(1,1)","easing":"linear"},{"offset":0.53655,"transform":"translate(0px,0px) rotate(-270deg) scale(1,1)","easing":"linear"},{"offset":0.56225,"transform":"translate(0px,0px) rotate(-300deg) scale(1,1)","easing":"linear"},{"offset":0.59438,"transform":"translate(0px,0px) rotate(-300deg) scale(1,1)","easing":"linear"},{"offset":0.64257,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)"}]},{"part":"rad","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.09639,"transform":"translate(0.2934px,-0.0624px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.12851,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.24016,"transform":"translate(-1.5719px,0.3341px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.29719,"transform":"translate(-2.2548px,0.4793px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.34217,"transform":"translate(-2.6171px,0.5563px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.38153,"transform":"translate(-2.9828px,0.634px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.41687,"transform":"translate(-3.3527px,0.7126px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.4498,"transform":"translate(-3.7278px,0.7924px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.48032,"transform":"translate(-4.11px,0.8736px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.50924,"transform":"translate(-4.5038px,0.9573px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.53655,"transform":"translate(-5.5265px,1.1747px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.56225,"transform":"translate(-7.0916px,1.5074px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.59438,"transform":"translate(-7.0916px,1.5074px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.64257,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)"}]},{"part":"dot","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","opacity":1,"easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.12851,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.23293,"transform":"translate(0px,0px) rotate(0deg) scale(0.72,0.72)","easing":"linear"},{"offset":0.4498,"transform":"translate(0px,0px) rotate(0deg) scale(0.6,0.6)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.56225,"transform":"translate(0px,0px) rotate(0deg) scale(0.4,0.4)","opacity":1,"easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.57831,"transform":"translate(0px,0px) rotate(0deg) scale(0.2,0.2)","opacity":0,"easing":"linear"},{"offset":0.69076,"transform":"translate(0px,0px) rotate(0deg) scale(0.2,0.2)","opacity":0,"easing":"cubic-bezier(.16,.75,.3,.95)"},{"offset":0.75502,"transform":"translate(0px,0px) rotate(0deg) scale(1.15,1.15)","opacity":1,"easing":"cubic-bezier(.37,0,.63,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)"}]},{"part":"gulp","keyframes":[{"offset":0,"transform":"scale(.4)","opacity":0},{"offset":0.55422,"transform":"scale(.4)","opacity":0,"easing":"cubic-bezier(.22,1,.36,1)"},{"offset":0.59438,"transform":"scale(.8)","opacity":0.9,"easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.77108,"transform":"scale(1.6)","opacity":0},{"offset":1,"transform":"scale(.4)","opacity":0}]}]},
  },
  /* ─────────────────────────────────────────────────────────
   * DELETE · TRASH · Actions · one act, 1063ms
   *
   * Lift → Slam → Settle
   *          The lid swings up on its hinge, hangs open, then falls shut; the bin gives under it and air puffs from the edge.
   *  lid        0 → 240 → 360 → 440 → 560 → 600 → 690 → 1063ms
   *  bin        0 → 560 → 600 → 905 → 1063ms
   *  puff       0 → 570 → 620 → 820 → 1063ms
   * Plays once through on hover, focus or click; finishes if the pointer leaves.
   * REDUCED MOTION   static glyph
   * ───────────────────────────────────────────────────────── */
  "trash": {
    label: "Delete · Trash",
    category: "Actions",
    hover: "The lid swings up on its hinge, hangs open, then falls shut; the bin gives under it and air puffs from the edge.",
    press: "plays the same act",
    pressMs: 1063,
    defs: "",
    ...
    sw16: 1.85,
    motion: {"duration":1063,"caption":"The lid swings up on its hinge, hangs open, then falls shut; the bin gives under it and air puffs from the edge.","stages":["Lift","Slam","Settle"],"tracks":[{"part":"lid","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.16,.75,.3,.95)"},{"offset":0.22578,"transform":"translate(0px,0px) rotate(-15.5deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.33866,"transform":"translate(0px,0px) rotate(-13.5deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.41392,"transform":"translate(0px,0px) rotate(-14deg) scale(1,1)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.52681,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.16,.75,.3,.95)"},{"offset":0.56444,"transform":"translate(0px,0.8px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.64911,"transform":"translate(0px,0px) rotate(-3.5deg) scale(1,1)","easing":"cubic-bezier(.37,0,.63,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)"}]},{"part":"bin","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.52681,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.16,.75,.3,.95)"},{"offset":0.56444,"transform":"translate(0px,0px) rotate(0deg) scale(1.03,0.94)","easing":"cubic-bezier(.37,0,.63,1)"},{"offset":0.85136,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)"}]},{"part":"puff","keyframes":[{"offset":0,"transform":"scale(.6)","opacity":0},{"offset":0.53622,"transform":"scale(.6)","opacity":0,"easing":"cubic-bezier(.22,1,.36,1)"},{"offset":0.58325,"transform":"scale(1)","opacity":1,"easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.7714,"transform":"scale(1.5)","opacity":0},{"offset":1,"transform":"scale(.6)","opacity":0}]}]},
  },
  /* ─────────────────────────────────────────────────────────
   * GROUP · STACK · Actions · one act, 1253ms
   *
   * Gather → Drop in → Land
   *          The two cards lift, square up into one stack and drop into the folder, splaying back into place as the flap takes the landing.
   *  card1      0 → 160 → 420 → 540 → 896 → 1253ms
   *  card2      0 → 120 → 380 → 540 → 896 → 1253ms
   *  flap       0 → 530 → 560 → 865 → 1253ms
   *  puff       0 → 545 → 600 → 820 → 1253ms
   * Plays once through on hover, focus or click; finishes if the pointer leaves.
   * REDUCED MOTION   static glyph
   * ───────────────────────────────────────────────────────── */
  "group": {
    label: "Group · Stack",
    category: "Actions",
    hover: "The two cards lift, square up into one stack and drop into the folder, splaying back into place as the flap takes the landing.",
    press: "plays the same act",
    pressMs: 1253,
    defs: "<mask id=\"&-m\" maskUnits=\"userSpaceOnUse\" x=\"0\" y=\"0\" width=\"24\" height=\"24\"><rect width=\"24\" height=\"24\" fill=\"#fff\" stroke=\"none\"/><path data-part=\"flap\" d=\"M1 11.2h22V24H1Z\" fill=\"#000\" stroke=\"none\"/></mask><mask id=\"&-b\" maskUnits=\"userSpaceOnUse\" x=\"0\" y=\"0\" width=\"24\" height=\"24\"><rect width=\"24\" height=\"24\" fill=\"#fff\" stroke=\"none\"/><g fill=\"#000\" stroke=\"#000\" stroke-width=\"3.3\"><g data-part=\"card1\"><rect x=\"5.6\" y=\"6.4\" width=\"8.2\" height=\"10\" rx=\"1.7\" transform=\"rotate(-8 9.7 16.4)\"/></g><g data-part=\"card2\"><rect x=\"10.2\" y=\"7.4\" width=\"8.2\" height=\"10\" rx=\"1.7\" transform=\"rotate(5 14.3 17.4)\"/></g></g></mask><mask id=\"&-c\" maskUnits=\"userSpaceOnUse\" x=\"0\" y=\"0\" width=\"24\" height=\"24\"><rect width=\"24\" height=\"24\" fill=\"#fff\" stroke=\"none\"/><g data-part=\"card2\"><rect x=\"10.2\" y=\"7.4\" width=\"8.2\" height=\"10\" rx=\"1.7\" transform=\"rotate(5 14.3 17.4)\" fill=\"#000\" stroke=\"#000\" stroke-width=\"3.3\"/></g></mask>",
    body: "<path mask=\"url(#&-b)\" d=\"M3.5 12.4V6.3a1.9 1.9 0 0 1 1.9-1.9h3.1a1.6 1.6 0 0 1 1.2.53l1.2 1.37h7.7a1.9 1.9 0 0 1 1.9 1.9v4.2\"/><g mask=\"url(#&-m)\"><g mask=\"url(#&-c)\"><g data-part=\"card1\"><rect x=\"5.6\" y=\"6.4\" width=\"8.2\" height=\"10\" rx=\"1.7\" transform=\"rotate(-8 9.7 16.4)\"/></g></g><g data-part=\"card2\"><rect class=\"f\" style=\"--duo:.14\" x=\"10.2\" y=\"7.4\" width=\"8.2\" height=\"10\" rx=\"1.7\" transform=\"rotate(5 14.3 17.4)\"/></g></g><g data-part=\"flap\"><path class=\"f\" style=\"--duo:.16\" d=\"M3.5 12.2h17v5.4a2.5 2.5 0 0 1-2.5 2.5H6a2.5 2.5 0 0 1-2.5-2.5Z\"/></g><path class=\"ac\" data-part=\"puff\" opacity=\"0\" d=\"M2.8 10.2l-.7-.7M21.2 10.2l.7-.7\" style=\"stroke-width:calc(var(--sw) * .7)\"/>",
  ...
  /* ─────────────────────────────────────────────────────────
   * UNDO · Actions · one act, 1010ms
   *
   * Wind → Reel back → Pay out
   *          The hook winds forward, whips back about its centre and reels its tail in; the head's echo carries on, a step back.
  ...
  "undo": {
    label: "Undo",
    category: "Actions",
    hover: "The hook winds forward, whips back about its centre and reels its tail in; the head's echo carries on, a step back.",
    press: "plays the same act",
    pressMs: 1010,
    defs: "",
  ...
  /* ─────────────────────────────────────────────────────────
   * MORE · Actions · one act, 1143ms
   *
   * Draw back → Knock → Carry on
   *          The first dot is struck into the row; the knock runs through and kicks the last one out: there is more.
   *  m1         0 → 160 → 250 → 320 → 420 → 1143ms
   *  m2         0 → 250 → 285 → 355 → 455 → 1143ms
   *  m3         0 → 285 → 330 → 430 → 786 → 1143ms
   *  knock      0 → 290 → 330 → 580 → 1143ms
   * Plays once through on hover, focus or click; finishes if the pointer leaves.
   * REDUCED MOTION   static glyph
   * ───────────────────────────────────────────────────────── */
  "more": {
    label: "More",
    category: "Actions",
    hover: "The first dot is struck into the row; the knock runs through and kicks the last one out: there is more.",
    press: "plays the same act",
    pressMs: 1143,
    defs: "",
  ...
  /* ─────────────────────────────────────────────────────────
   * CAPTURE · Status · one act, 950ms
   *
   * Focus → Shutter → Let go
   *          The corners close in and hunt for focus, lock, and the shutter blinks over the aperture.
   *  nw         0 → 190 → 290 → 380 → 600 → 720 → 830 → 950ms
   *  ne         0 → 190 → 290 → 380 → 600 → 720 → 830 → 950ms
   *  se         0 → 190 → 290 → 380 → 600 → 720 → 830 → 950ms
   *  sw         0 → 190 → 290 → 380 → 600 → 720 → 830 → 950ms
   *  shutter    0 → 430 → 480 → 560 → 640 → 950ms
   * Plays once through on hover, focus or click; finishes if the pointer leaves.
   * REDUCED MOTION   static glyph
   * ───────────────────────────────────────────────────────── */
  "capture": {
    label: "Capture",
    category: "Status",
    hover: "The corners close in and hunt for focus, lock, and the shutter blinks over the aperture.",
    press: "plays the same act",
    pressMs: 950,
    defs: "",
    ...
    sw16: 1.85,
    motion: {"duration":950,"caption":"The corners close in and hunt for focus, lock, and the shutter blinks over the aperture.","stages":["Focus","Shutter","Let go"],"tracks":[{"part":"nw","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.2,"transform":"translate(1.5px,1.5px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.30526,"transform":"translate(0.8px,0.8px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.4,"transform":"translate(1.1px,1.1px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.63158,"transform":"translate(1.1px,1.1px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.75789,"transform":"translate(-0.35px,-0.35px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.87368,"transform":"translate(0.1px,0.1px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.22,1,.36,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"}]},{"part":"ne","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.2,"transform":"translate(-1.5px,1.5px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.30526,"transform":"translate(-0.8px,0.8px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.4,"transform":"translate(-1.1px,1.1px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.63158,"transform":"translate(-1.1px,1.1px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.75789,"transform":"translate(0.35px,-0.35px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.87368,"transform":"translate(-0.1px,0.1px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.22,1,.36,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"}]},{"part":"se","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.2,"transform":"translate(-1.5px,-1.5px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.30526,"transform":"translate(-0.8px,-0.8px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.4,"transform":"translate(-1.1px,-1.1px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.63158,"transform":"translate(-1.1px,-1.1px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.75789,"transform":"translate(0.35px,0.35px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.87368,"transform":"translate(-0.1px,-0.1px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.22,1,.36,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"}]},{"part":"sw","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.2,"transform":"translate(1.5px,-1.5px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.30526,"transform":"translate(0.8px,-0.8px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.4,"transform":"translate(1.1px,-1.1px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.63158,"transform":"translate(1.1px,-1.1px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.75789,"transform":"translate(-0.35px,0.35px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.87368,"transform":"translate(0.1px,-0.1px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.22,1,.36,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"}]},{"part":"shutter","keyframes":[{"offset":0,"transform":"scale(.3)","opacity":0},{"offset":0.45263,"transform":"scale(.3)","opacity":0,"easing":"cubic-bezier(.16,.75,.3,.95)"},{"offset":0.50526,"transform":"scale(1)","opacity":1},{"offset":0.58947,"transform":"scale(1)","opacity":1,"easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.67368,"transform":"scale(.5)","opacity":0},{"offset":1,"transform":"scale(.3)","opacity":0}]}]},
  },
  /* ─────────────────────────────────────────────────────────
   * PASTE · Status · one act, 900ms
   *
   * Open → Drop → Clamp
   *          The clip levers open, the content drops onto the board, and the clip clamps it down.
   *  clip       0 → 180 → 450 → 520 → 620 → 740 → 900ms
   *  l1         0 → 140 → 220 → 340 → 420 → 500 → 900ms
   *  l2         0 → 140 → 290 → 410 → 490 → 570 → 900ms
   *  clack      0 → 510 → 550 → 740 → 900ms
   * Plays once through on hover, focus or click; finishes if the pointer leaves.
   * REDUCED MOTION   static glyph
   * ───────────────────────────────────────────────────────── */
  "paste": {
    label: "Paste",
    category: "Status",
    hover: "The clip levers open, the content drops onto the board, and the clip clamps it down.",
    press: "plays the same act",
    pressMs: 900,
    defs: "",
    ...
    sw16: 1.85,
    motion: {"duration":900,"caption":"The clip levers open, the content drops onto the board, and the clip clamps it down.","stages":["Open","Drop","Clamp"],"tracks":[{"part":"clip","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.2,"transform":"translate(0px,-1px) rotate(-10deg) scale(1,1)","easing":"linear"},{"offset":0.5,"transform":"translate(0px,-1px) rotate(-10deg) scale(1,1)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.57778,"transform":"translate(0px,0.3px) rotate(0deg) scale(1.04,0.9)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.68889,"transform":"translate(0px,-0.15px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.82222,"transform":"translate(0px,0.05px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.22,1,.36,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)"}]},{"part":"l1","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","opacity":1,"easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.15556,"transform":"translate(0px,-0.8px) rotate(0deg) scale(1,1)","opacity":0,"easing":"linear"},{"offset":0.24444,"transform":"translate(0px,-3.2px) rotate(0deg) scale(1,1)","opacity":0,"easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.37778,"transform":"translate(0px,0.5px) rotate(0deg) scale(1,1)","opacity":1,"easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.46667,"transform":"translate(0px,-0.15px) rotate(0deg) scale(1,1)","opacity":1,"easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.55556,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","opacity":1,"easing":"linear"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","opacity":1,"easing":"cubic-bezier(.4,0,.2,1)"}]},{"part":"l2","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","opacity":1,"easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.15556,"transform":"translate(0px,-0.8px) rotate(0deg) scale(1,1)","opacity":0,"easing":"linear"},{"offset":0.32222,"transform":"translate(0px,-3.2px) rotate(0deg) scale(1,1)","opacity":0,"easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.45556,"transform":"translate(0px,0.5px) rotate(0deg) scale(1,1)","opacity":1,"easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.54444,"transform":"translate(0px,-0.15px) rotate(0deg) scale(1,1)","opacity":1,"easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.63333,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","opacity":1,"easing":"linear"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","opacity":1,"easing":"cubic-bezier(.4,0,.2,1)"}]},{"part":"clack","keyframes":[{"offset":0,"transform":"scale(.6)","opacity":0},{"offset":0.56667,"transform":"scale(.6)","opacity":0,"easing":"cubic-bezier(.22,1,.36,1)"},{"offset":0.61111,"transform":"scale(1)","opacity":1,"easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.82222,"transform":"scale(1.25)","opacity":0},{"offset":1,"transform":"scale(.6)","opacity":0}]}]},
  },
  /* ─────────────────────────────────────────────────────────
   * KEEPER · Status · one act, 1150ms
   *
   * Notice → Nod → Settle
   *          The character looks up at it, perks up, and nods it in with a slow blink; its ring tips with the nod.
   *  body       0 → 200 → 380 → 470 → 620 → 760 → 900 → 1150ms
   *  ring       0 → 260 → 400 → 520 → 680 → 820 → 960 → 1150ms
   *  ringb      0 → 260 → 400 → 520 → 680 → 820 → 960 → 1150ms
   *  eyes       0 → 200 → 380 → 470 → 580 → 680 → 820 → 1150ms
   *  notice     0 → 140 → 230 → 440 → 1150ms
   * Plays once through on hover, focus or click; finishes if the pointer leaves.
   * REDUCED MOTION   static glyph
   * ───────────────────────────────────────────────────────── */
  "keeper": {
    label: "Keeper",
    category: "Status",
    hover: "The character looks up at it, perks up, and nods it in with a slow blink; its ring tips with the nod.",
    press: "plays the same act",
    pressMs: 1150,
    defs: "<mask id=\"&-k\" maskUnits=\"userSpaceOnUse\" x=\"0\" y=\"0\" width=\"24\" height=\"24\"><rect width=\"24\" height=\"24\" fill=\"#fff\" stroke=\"none\"/><g data-part=\"eyes\"><rect x=\"8.9\" y=\"7.5\" width=\"2.4\" height=\"4.2\" rx=\"1.2\" fill=\"#000\" stroke=\"none\"/><rect x=\"12.7\" y=\"7.5\" width=\"2.4\" height=\"4.2\" rx=\"1.2\" fill=\"#000\" stroke=\"none\"/></g><g data-part=\"ring\"><path d=\"M2.2 12.8a9.8 2.5 0 0 0 19.6 0\" fill=\"none\" stroke=\"#000\" stroke-width=\"4\" transform=\"rotate(-12 12 12.8)\"/></g></mask><mask id=\"&-kb\" maskUnits=\"userSpaceOnUse\" x=\"0\" y=\"0\" width=\"24\" height=\"24\"><rect width=\"24\" height=\"24\" fill=\"#fff\" stroke=\"none\"/><circle cx=\"12\" cy=\"11.4\" r=\"8\" fill=\"#000\" stroke=\"none\"/></mask>",
    body: "<g data-part=\"body\"><g mask=\"url(#&-kb)\"><g data-part=\"ringb\"><path d=\"M2.2 12.8a9.8 2.5 0 0 1 19.6 0\" transform=\"rotate(-12 12 12.8)\" style=\"stroke-width:calc(var(--sw) * .88)\"/></g></g><circle class=\"s\" mask=\"url(#&-k)\" cx=\"12\" cy=\"11.4\" r=\"6.8\"/><g data-part=\"ring\"><path d=\"M2.2 12.8a9.8 2.5 0 0 0 19.6 0\" transform=\"rotate(-12 12 12.8)\" style=\"stroke-width:calc(var(--sw) * .88)\"/></g><g data-part=\"eyes\"/></g><path class=\"ac\" data-part=\"notice\" opacity=\"0\" d=\"M8.9 3.6 8.2 2.7M12 3.1V2.1M15.1 3.6 15.8 2.7\" style=\"stroke-width:calc(var(--sw) * .7)\"/>",
    ...
    sw16: 1.9,
    motion: {"duration":1150,"caption":"The character looks up at it, perks up, and nods it in with a slow blink; its ring tips with the nod.","stages":["Notice","Nod","Settle"],"tracks":[{"part":"body","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.17391,"transform":"translate(0px,-0.6px) rotate(0deg) scale(1,1.04)","easing":"linear"},{"offset":0.33043,"transform":"translate(0px,-0.6px) rotate(0deg) scale(1,1.04)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.4087,"transform":"translate(0px,0.9px) rotate(0deg) scale(1.07,0.93)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.53913,"transform":"translate(0px,-0.35px) rotate(0deg) scale(1,1.02)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.66087,"transform":"translate(0px,0.1px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.22,1,.36,1)"},{"offset":0.78261,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"}]},{"part":"ring","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.22609,"transform":"translate(0px,0px) rotate(4deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.34783,"transform":"translate(0px,0px) rotate(4deg) scale(1,1)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.45217,"transform":"translate(0px,0px) rotate(-10deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.5913,"transform":"translate(0px,0px) rotate(4deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.71304,"transform":"translate(0px,0px) rotate(-1.5deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.83478,"transform":"translate(0px,0px) rotate(0.4deg) scale(1,1)","easing":"cubic-bezier(.22,1,.36,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"}]},{"part":"ringb","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.22609,"transform":"translate(0px,0px) rotate(4deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.34783,"transform":"translate(0px,0px) rotate(4deg) scale(1,1)","easing":"cubic-bezier(.55,0,.85,.45)"},{"offset":0.45217,"transform":"translate(0px,0px) rotate(-10deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.5913,"transform":"translate(0px,0px) rotate(4deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.71304,"transform":"translate(0px,0px) rotate(-1.5deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.83478,"transform":"translate(0px,0px) rotate(0.4deg) scale(1,1)","easing":"cubic-bezier(.22,1,.36,1)"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"}]},{"part":"eyes","keyframes":[{"offset":0,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.16,.75,.3,.95)"},{"offset":0.17391,"transform":"translate(0.5px,-1.1px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":0.33043,"transform":"translate(0.5px,-1.1px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.4087,"transform":"translate(0px,0.2px) rotate(0deg) scale(1,0.15)","easing":"linear"},{"offset":0.50435,"transform":"translate(0px,0.2px) rotate(0deg) scale(1,0.15)","easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.5913,"transform":"translate(0px,-0.1px) rotate(0deg) scale(1,1.05)","easing":"cubic-bezier(.22,1,.36,1)"},{"offset":0.71304,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"linear"},{"offset":1,"transform":"translate(0px,0px) rotate(0deg) scale(1,1)","easing":"cubic-bezier(.4,0,.2,1)"}]},{"part":"notice","keyframes":[{"offset":0,"transform":"scale(.6)","opacity":0},{"offset":0.12174,"transform":"scale(.6)","opacity":0,"easing":"cubic-bezier(.22,1,.36,1)"},{"offset":0.2,"transform":"scale(1)","opacity":1,"easing":"cubic-bezier(.4,0,.2,1)"},{"offset":0.38261,"transform":"scale(1.2)","opacity":0},{"offset":1,"transform":"scale(.6)","opacity":0}]}]},
  },
  /* ─────────────────────────────────────────────────────────
   * NEW · Actions · one act, 875ms
   *
   * Lift → Insert → Propagate
   *          The upright is lifted and driven into the waiting crossbar; the knock runs out to the bar's ends.
   *  upright    0 → 170 → 250 → 555 → 860 → 875ms
   *  bar        0 → 245 → 265 → 570 → 875ms
   *  tile       0 → 255 → 290 → 646 → 875ms
   *  beads      0 → 285 → 320 → 540 → 875ms
   * Plays once through on hover, focus or click; finishes if the pointer leaves.
   * REDUCED MOTION   static glyph
   * ───────────────────────────────────────────────────────── */
  "plus": {
    label: "New",
    category: "Actions",
    hover: "The upright is lifted and driven into the waiting crossbar; the knock runs out to the bar's ends.",
    press: "plays the same act",
    pressMs: 875,
    defs: "",
