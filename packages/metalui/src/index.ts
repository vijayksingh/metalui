...
export { Key, type KeyProps } from './components/key/key';
export { Bezel, type BezelProps } from './components/bezel/bezel';
export { Backlight, type BacklightProps } from './components/backlight/backlight';
