// Boolean outliner (CoreGraphics), ported from the Kamui SF Symbols export. MetalUI uses it in
// scripts/build-morph.mjs to cut masked and clipped fills into exact plates.
//
