...
private struct MetalTintModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        // The stroke carries the feeling and the duotone body follows it. Under Increase
        // Contrast, or with tints off, the glyph keeps the surrounding ink.
...
extension View {
    /// Colors a feelings or moment glyph's stroke (and so its duotone body) with its tint. Never use it on text.
