...
public enum MetalGadgetJob: String, CaseIterable, Sendable {
    ...
    public var stations: [Double] { switch self { case .tune: return [80.0]; case .command: return [95.0]; case .link: return [195.0, 230.0]; case .keep: return [140.0, 300.0]; case .identify: return [260.0]; case .destroy: return [25.0]; case .take: return [55.0]; case .find: return [250.0]; case .make: return [330.0]; case .signal: return [55.0, 80.0] } }
