...
public enum MetalRecipes {
    ...
    public static let folder = MetalObjectRecipe(
        ...
        props: [
            ...
            "name.gap": .number(4.0),
            "pose.c1-rest-y": .text("-10px"),
            "pose.c1-rest-r": .text("10deg"),
            "pose.c1-hover-y": .text("-30px"),
            "pose.c1-hover-r": .text("14deg"),
            "pose.c1-open-y": .text("-86px"),
            "pose.c1-open-r": .text("18deg"),
            "pose.c2-rest-y": .text("-10px"),
            "pose.c2-rest-r": .text("2deg"),
            "pose.c2-hover-y": .text("-37px"),
            "pose.c2-hover-r": .text("-1deg"),
            "pose.c2-open-y": .text("-96px"),
            "pose.c2-open-r": .text("-3deg"),
            "pose.c3-rest-y": .text("-10px"),
            "pose.c3-rest-r": .text("-5deg"),
            "pose.c3-hover-y": .text("-44px"),
